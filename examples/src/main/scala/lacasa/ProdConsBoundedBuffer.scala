...
object ProdConsBoundedBuffer {
  ...
  private case class DataItemMessage(data: Double, producer: ActorRef) extends Message

  private case class ProduceDataMessage() extends Message

  private case class ProducerExitMessage() extends Message

  private case class ConsumerAvailableMessage(consumer: ActorRef) extends Message
