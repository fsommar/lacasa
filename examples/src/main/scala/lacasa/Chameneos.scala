...
object Chameneos {
  ...
  private case class MeetMsg(color: Color, sender: ActorRef) extends Message

  private case class ChangeMsg(color: Color, sender: ActorRef) extends Message

  private case class MeetingCountMsg(count: Int, sender: ActorRef) extends Message
  
  private case class ExitMsg(sender: ActorRef) extends Message

  private class ChameneosMallActor(var meetingsLeft: Int, numChameneos: Int) extends Actor[Message] {
