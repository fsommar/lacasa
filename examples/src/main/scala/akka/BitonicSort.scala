...
object BitonicSort {
  ...
  private case class ExitMessage()


  private class ValueDataAdapterActor(orderId: Int, nextActor: ActorRef) extends Actor {
  ...
  private class DataValueAdapterActor(nextActor: ActorRef) extends Actor {
    override def receive: Receive = {
      case vm: ValueMessage =>
        nextActor ! vm
  ...
  private class RoundRobinSplitterActor(name: String, length: Int, receivers: Array[ActorRef]) extends Actor {
  ...
  private class RoundRobinJoinerActor(name: String, length: Int, numJoiners: Int, nextActor: ActorRef) extends Actor {
   ...
   */
  private class CompareExchangeActor(orderId: Int, sortDirection: Boolean, nextActor: ActorRef) extends Actor {
   ...
   */
  private class PartitionBitonicSequenceActor(orderId: Int, length: Int, sortDir: Boolean, nextActor: ActorRef) extends Actor {
   ...
   */
  private class StepOfMergeActor(orderId: Int, length: Int, numSeqPartitions: Int, directionCounter: Int, nextActor: ActorRef) extends Actor {
   ...
   */
  private class StepOfLastMergeActor(length: Int, numSeqPartitions: Int, sortDirection: Boolean, nextActor: ActorRef) extends Actor {
   ...
   */
  private class MergeStageActor(P: Int, N: Int, nextActor: ActorRef) extends Actor {
   ...
   */
  private class LastMergeStageActor(N: Int, sortDirection: Boolean, nextActor: ActorRef) extends Actor {
   ...
   */
  private class BitonicSortKernelActor(N: Int, sortDirection: Boolean, nextActor: ActorRef) extends Actor {
  ...
  private class IntSourceActor(numValues: Int, maxValue: Long, seed: Long, nextActor: ActorRef) extends Actor {
  ...
  private class ValidationActor(numValues: Int) extends Actor {
